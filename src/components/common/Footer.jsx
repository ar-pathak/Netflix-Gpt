...
const Footer = ({ compact = false }) => {
    ...
    // Simplified links for compact mode
    const compactLinks = [
        { name: 'Privacy', url: '#' },
        { name: 'Terms', url: '#' },
        { name: 'Help', url: '#' },
    ...
    if (compact) {
        return (
            <footer className="bg-transparent pt-4 pb-6">
    ...
    return (
        <footer className="bg-gray-900 pt-16 pb-12 border-t border-gray-800">
            ...
            {showBackToTop && (
                <button 
                    onClick={scrollToTop}
                    className="fixed bottom-8 right-8 bg-red-600 hover:bg-red-700 text-white p-3 rounded-full shadow-lg transition-all transform hover:scale-110 z-50"
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        <h3 className="text-red-600 text-lg font-bold mb-4">{APP_CONFIG.NAME}</h3>
                        <p className="text-gray-400 text-sm">
                            {APP_CONFIG.DESCRIPTION} - your ultimate movie discovery platform powered by AI.
                            Explore thousands of movies and TV shows in one place.
                        </p>
                    ...
                    {footerLinks.map((column, index) => (
                        <div key={index}>
                            <h3 className="text-white text-lg font-medium mb-4">{column.title}</h3>
